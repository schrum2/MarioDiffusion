...
python create_level_json_data.py --output "datasets\\LR_Levels.json" --levels "..\\TheVGLC\\Lode Runner\\Processed" --tileset Game_LodeRunner/LodeRunner.json --target_height 32 --target_width 32 --extra_tile .
