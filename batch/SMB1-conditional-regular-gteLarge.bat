...
python evaluate_caption_adherence.py --model_path SMB1-conditional-regular-gteLarge --save_as_json --json datasets\\SMB1_LevelsAndCaptions-regular-test.json --compare_checkpoints 
python evaluate_caption_adherence.py --model_path SMB1-conditional-regular-gteLarge --save_as_json --json datasets\\SMB1_RandomTest-regular.json --compare_checkpoints
