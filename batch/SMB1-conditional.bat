...
python evaluate_caption_adherence.py --model_path %DIFF_OUTPUT% --save_as_json --json datasets\SMB1_LevelsAndCaptions-%TYPE%.json --output_dir text-to-level-final
python evaluate_caption_adherence.py --model_path %DIFF_OUTPUT% --save_as_json --json datasets\SMB1_LevelsAndCaptions-%TYPE%.json --compare_checkpoints 
python evaluate_caption_adherence.py --model_path %DIFF_OUTPUT% --save_as_json --json datasets\SMB1_LevelsAndCaptions-%TYPE%-test.json --compare_checkpoints 
python evaluate_caption_adherence.py --model_path %DIFF_OUTPUT% --save_as_json --json datasets\SMB1_RandomTest-%TYPE%.json --compare_checkpoints
