...
REM python llm_ascii_to_caption.py --levels Game_MMLV\DATA\MMLV_LevelsAndCaptions-llm-qwen.json --game MMLV --llm ollama --model gemma4:12b --output Game_MMLV\DATA\MMLV_LevelsAndCaptions-llm.json --num_captions 5
...
call train-diffusion.bat 0 MMLV llm MMLV CLIP single none 0 300 3 no no qwen3.5:9b_captions
call train-diffusion.bat 0 MMLV llm MMLV CLIP single none 0 300 5 no no qwen3.5:9b_captions
