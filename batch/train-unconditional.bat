...
python train_diffusion.py --augment --output_dir "%DIFF_OUTPUT%" --num_epochs 500 --json datasets\%GAME%_LevelsAndCaptions-regular-train.json --val_json datasets\%GAME%_LevelsAndCaptions-regular-validate.json --seed %SEED%
