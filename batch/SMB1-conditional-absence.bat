...
python evaluate_caption_adherence.py --model_path SMB1-conditional-absence --save_as_json --json datasets\\SMB1_LevelsAndCaptions-absence-test.json --compare_checkpoints 
python evaluate_caption_adherence.py --model_path SMB1-conditional-absence --save_as_json --json datasets\\SMB1_RandomTest-absence.json --compare_checkpoints 
