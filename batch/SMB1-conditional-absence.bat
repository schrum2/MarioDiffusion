...
python evaluate_caption_adherence.py --model_path SMB1-conditional-absence --save_as_json --json datasets\\SMB1_LevelsAndCaptions-absence-train.json --output_dir text-to-level-final
python evaluate_caption_adherence.py --model_path SMB1-conditional-absence --save_as_json --json datasets\\SMB1_LevelsAndCaptions-absence-train.json --compare_checkpoints 
