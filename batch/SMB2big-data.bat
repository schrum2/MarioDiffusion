...
set default_out=datasets\SMB2_LevelsAndCaptions_BIG

:: Convert SMB2 raw level data to JSON
python create_level_json_data.py --output "datasets\\SMB2_Levels_BIG.json" --levels "..\\TheVGLC\\Super Mario Bros 2 (Japan)\\Processed"

:: Generate captions for SMB2
python create_ascii_captions.py --dataset datasets\\SMB2_Levels_BIG.json --output %default_out%-regular.json
python create_ascii_captions.py --dataset datasets\\SMB2_Levels_BIG.json --output %default_out%-absence.json --describe_absence
...
python create_random_test_captions.py --save_file "datasets\\SMB2_RandomTest-regular_BIG.json" --json %default_out%-regular.json --seed 0
python create_random_test_captions.py --save_file "datasets\\SMB2_RandomTest-absence-BIG.json" --json %default_out%-absence.json --seed 0 --describe_absence
