...
python evaluate_caption_adherence.py --model_path LR-conditional-regular --save_as_json --json datasets\\LR_LevelsAndCaptions-regular.json --output_dir text-to-level-final
python evaluate_caption_adherence.py --model_path LR-conditional-regular --save_as_json --json datasets\\LR_LevelsAndCaptions-regular.json --compare_checkpoints
python evaluate_caption_adherence.py --model_path LR-conditional-regular --save_as_json --json datasets\\LR_LevelsAndCaptions-regular-test.json --compare_checkpoints
python evaluate_caption_adherence.py --model_path LR-conditional-regular --save_as_json --json datasets\\LR_RandomTest-regular.json --compare_checkpoints