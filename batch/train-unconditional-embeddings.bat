...
python train_diffusion.py --augment --output_dir "TILE_EMBEDDING%EMBEDDING_DIM%_Mar1and2-unconditional-block2vec" --num_epochs 500 --json datasets\Mar1and2_LevelsAndCaptions-regular-train.json --val_json datasets\Mar1and2_LevelsAndCaptions-regular-validate.json --block_embedding_model_path "TILE_EMBEDDING%EMBEDDING_DIM%_Mar1and2-block2vec-embeddings" --plot_validation_caption_score
python run_diffusion.py --model_path "TILE_EMBEDDING%EMBEDDING_DIM%_Mar1and2-unconditional-block2vec" --num_samples 100 --save_as_json --output_dir "TILE_EMBEDDING%EMBEDDING_DIM%_Mar1and2-unconditional-block2vec-samples"
