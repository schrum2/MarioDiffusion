...
python evaluate_caption_adherence.py --model_path LR-conditional-absence --save_as_json --json datasets\\LR_LevelsAndCaptions-absence.json --output_dir text-to-level-final --num_tiles 8
python evaluate_caption_adherence.py --model_path LR-conditional-absence --save_as_json --json datasets\\LR_LevelsAndCaptions-absence.json --compare_checkpoints --num_tiles 8
python evaluate_caption_adherence.py --model_path LR-conditional-absence --save_as_json --json datasets\\LR_LevelsAndCaptions-absence-test.json --compare_checkpoints --num_tiles 8
python evaluate_caption_adherence.py --model_path LR-conditional-absence --save_as_json --json datasets\\LR_RandomTest-absence.json --compare_checkpoints --num_tiles 8