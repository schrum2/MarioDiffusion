...
python create_validation_captions.py --save_file "datasets\\SML_ValidationCaptions-regular.json" --json %default_out%-regular.json --seed 0
python create_validation_captions.py --save_file "datasets\\SML_ValidationCaptions-absence.json" --json %default_out%-absence.json --seed 0 --describe_absence
