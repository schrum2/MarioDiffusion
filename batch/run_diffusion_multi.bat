...
python run_diffusion.py --model_path %MODEL_PATH% --num_samples 100 %TEXT_FLAG% --save_as_json --output_dir "%UNCOND_OUTPUT%-short" %DESCRIBE_ABSENCE_FLAG% %GAME_PLAYED%
python run_diffusion.py --model_path %MODEL_PATH% --num_samples 100 %TEXT_FLAG% --save_as_json --output_dir "%UNCOND_OUTPUT%-long" %DESCRIBE_ABSENCE_FLAG% --level_width 128 %GAME_PLAYED%
