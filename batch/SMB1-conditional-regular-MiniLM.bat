...
python train_diffusion.py --augment --text_conditional --output_dir "SMB1-conditional-regular-MiniLM" --num_epochs 500 --json datasets\\SMB1_LevelsAndCaptions-regular-train.json --val_json datasets\\SMB1_LevelsAndCaptions-regular-validate.json --pretrained_language_model "sentence-transformers/multi-qa-MiniLM-L6-cos-v1" --plot_validation_caption_score
...
python evaluate_caption_adherence.py --model_path SMB1-conditional-regular-MiniLM --save_as_json --json datasets\\SMB1_ValidationCaptions-regular.json --compare_checkpoints
