...
python train_diffusion.py --save_image_epochs 1000 --augment --text_conditional --output_dir "%DIFF_OUTPUT%" --num_epochs 500 --json %TRAIN_DATA% --val_json %VAL_DATA% --pretrained_language_model "%MODEL_NAME%" --plot_validation_caption_score --game %GAME% --seed %SEED% %DIFF_FLAGS% %SPLIT_FLAG% %DESCRIBE_ABSENCE_FLAG% 
