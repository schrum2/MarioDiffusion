...
python create_validation_captions.py --save_file "datasets\\SMB1_ValidationCaptions-regular.json" --json %default_out%-regular.json --seed 0 --no_upside_down_pipes
python create_validation_captions.py --save_file "datasets\\SMB1_ValidationCaptions-absence.json" --json %default_out%-absence.json --seed 0 --describe_absence --no_upside_down_pipes
