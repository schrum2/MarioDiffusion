...
python -m mm2pipeline_data dataset build --input MM2_Data\ascii --output_folder MM2_Data\dataset\dataset.json --tileset mm2_tileset_we.json --sliding_window --stride 20
