...
python -m mm2pipeline_data dataset build --input MM2_Data\ascii --output_folder MM2_Data\dataset\dataset.json --tileset Game_MM2\mm2_tileset_we.json --sliding_window --stride 20 --strip_goal
