...
python run_diffusion.py --model_path Mario-conditional-model --num_samples 100 --text_conditional --save_as_json --output_dir "Mario-conditional-model-unconditional-samples"
python evaluate_caption_adherence.py --model_path Mario-conditional-model --save_as_json --json Mario_LevelsAndCaptions.json --output_dir conditional-model-text-to-level-final
python evaluate_caption_adherence.py --model_path Mario-conditional-model --save_as_json --json Mario_LevelsAndCaptions.json --compare_checkpoints 
python evaluate_caption_adherence.py --model_path Mario-conditional-model --save_as_json --json Mario_ValidationCaptions.json --compare_checkpoints 