...
python train_mlm.py --epochs 300 --save_checkpoints --json Mario_LevelsAndCaptions-regular.json --pkl Mario_Tokenizer-regular.pkl --output_dir mlm-regular --split
