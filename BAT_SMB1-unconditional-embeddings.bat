...
python train_diffusion.py --augment --output_dir "SMB1-unconditional-block2vec" --num_epochs 500 --json SMB1_LevelsAndCaptions-regular.json --block_embedding_model_path "SMB1-block2vec-embeddings"
