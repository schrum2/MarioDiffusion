...
python train_diffusion.py --augment --text_conditional --output_dir "SMB1-conditional-absence" --num_epochs 200 --json SMB1_LevelsAndCaptions-absence.json --pkl SMB1_Tokenizer-absence.pkl --mlm_model_dir SMB1-MLM-absence --split --plot_validation_caption_score
...
python evaluate_caption_adherence.py --model_path SMB1-conditional-absence --save_as_json --json Mario_ValidationCaptions-absence.json --compare_checkpoints 
