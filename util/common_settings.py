...
MARIO_HEIGHT = 16 
MARIO_WIDTH = 16
MARIO_TILESET = 'Game_Mario/smb.json'
...
MMLV_TILE_COUNT = 51
MMLV_TILESET = 'Game_MMLV/MMLV.json'
...
# Game_MMLV/bulk_mmlv_download.py writes/updates it as levels are downloaded; create_megaman_json_data.py
