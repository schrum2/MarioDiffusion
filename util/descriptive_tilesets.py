...
# Built-in simplified Mega Man tileset: this matches MM-Simple scene encodings.
# All enemies are collapsed into a single enemy tile, and many power-up/metadata markers
# are grouped with the existing power-up tile.
