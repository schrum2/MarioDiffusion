...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_seq_length", type=int, default=100, help="Maximum token sequence length for the transformer")
    ...
    model = TransformerModel(
        vocab_size, embedding_dim, hidden_dim, tokenizer,
