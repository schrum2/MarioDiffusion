...
python train_diffusion.py --game MM-Simple --augment --output_dir MM-simple%width_suffix%-unconditional0 --num_epochs 500 --json datasets\MM-simple_LevelsAndCaptions%width_suffix%-regular-train.json --val_json datasets\MM-simple_LevelsAndCaptions%width_suffix%-regular-validate.json --seed 0