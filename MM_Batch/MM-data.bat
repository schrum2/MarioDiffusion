...
python MM_create_ascii_captions.py --dataset datasets\\MM-full_Levels.json --tileset Game_MM/MM.json --output datasets\\MM-full_LevelsAndCaptions-regular.json
python MM_create_ascii_captions.py --dataset datasets\\MM-simple_Levels.json --tileset Game_MM/MM-Simple-tileset.json --output datasets\\MM-simple_LevelsAndCaptions-regular.json
