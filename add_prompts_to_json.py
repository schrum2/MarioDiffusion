...
# add_prompts_to_json.py --source_json Game_Mario/DATA/Mar1and2_LevelsAndCaptions-regular.json --target_json Mar1and2-conditional-regular0/samples-from-real-Mar1and2-captions-OLD/all_levels.json
