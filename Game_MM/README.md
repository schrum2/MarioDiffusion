...
```
python train_diffusion.py --save_image_epochs 20 --text_conditional --output_dir MM-Full-MM-Full-conditional-llm0 --num_epochs 1000 --json Game_MM/DATA/MM-Full_LevelsAndCaptions-llm-train.json --val_json Game_MM/DATA/MM-Full_LevelsAndCaptions-llm-validate.json --plot_validation_caption_score --seed 0 --game MM-Full --pretrained_language_model "sentence-transformers/clip-ViT-L-14" --caption_source_keys gemma4:12b_captions qwen3.5:9b_captions
```
