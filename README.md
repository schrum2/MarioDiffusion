...
Generate Mario level scenes with a diffusion model conditioned on text input. The initial work on this topic was published in 2025 in the publication listed below. However, further research has been conducted with this repo to provide more complex features for more games using more data.
...
- Mario 1 and Mario 2 using VGLC Data (Original work from AIIDE 2025 paper)
