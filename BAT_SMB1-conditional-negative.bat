python train_diffusion.py --augment --text_conditional --output_dir "SMB1-conditional-negative" --num_epochs 200 --json SMB1_LevelsAndCaptions-regular.json --pkl SMB1_Tokenizer-regular.pkl --mlm_model_dir SMB1-MLM-regular --negative_prompt_training --split --plot_validation_caption_score
