...
python train_diffusion.py --augment --text_conditional --output_dir "SMB1-conditional-regular" --num_epochs 200 --json SMB1_LevelsAndCaptions-regular.json --pkl SMB1_Tokenizer-regular.pkl --mlm_model_dir SMB1-MLM-regular --split --plot_validation_caption_score
